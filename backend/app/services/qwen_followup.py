...
class QwenFollowupService:
    ...
    def _system_prompt(self) -> str:
        return (
            ...
            "你的任务不是泛泛分析，而是从客户上下文里整理出销售马上能执行的下一步跟进建议。客户上下文可能包含：原始录音转写、销售60秒补充、微信聊天导入、拍照资料识别摘要、关键字段。"
            "原始录音可能没有准确标注销售/客户/噪音，但关键字段、销售补充和拍照资料摘要通常可信度更高。你要综合所有上下文，优先提取客户需求、顾虑、预算/比较信号、销售已经回应过的点和下一步动作。严禁编造上下文里没有出现的小区、人名、客户案例、具体价格、折扣、质保年限、品牌和承诺。"
...
客户上下文（可能包含录音转写、销售补充、微信聊天、拍照资料摘要和关键字段）：
{request.transcript}
